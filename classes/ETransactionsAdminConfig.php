...
$('#ETRANS_WEB_CASH_DIRECT').change(function() {
    if (this.value == 1 || this.value == 2) {
        $('#ETRANS_RECURRING_ENABLE_container').show('normal');
    }
    else {
        $('#ETRANS_RECURRING_ENABLE_container').hide('normal');
        $('#ETRANS_RECURRING_ENABLE').val('0').trigger('change');
    }
}).change();
(function($){
